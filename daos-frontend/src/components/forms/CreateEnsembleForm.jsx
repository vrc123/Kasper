...
export default function CreateEnsembleForm() {
    ...
    return (
        <form className={styles.createEnsembleFormDefault}>
            <InputTagText inputText="Ensemble name" />
            <LabelTag labelType="normal" labelColor="blue" labelText="Description" />
            <TextareaTag textAreatText="Write a short description of your ensemble or orchestra..." />
            ...
            <DisabledButton disabledButtonText="Creating ensemble" />
        </form>
    );
}